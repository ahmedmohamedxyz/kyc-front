...
export default function CustomersTableComponent({ thead, tbody,refreshPage }) {
                        ...
                        <tr key={ index }> 
                            ...
                            <td>
                                <div className="mc-table-action">
                                    ...
                                    <ButtonComponent title="Edit" className="material-icons edit" onClick={()=> window.location.href="/customer-account/"+item.id}>{ "edit" }</ButtonComponent>
                                </div>
                            </td>
                        </tr>
                    ))}
